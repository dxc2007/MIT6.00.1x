...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        return [dict(x) for x in self.message_text]
...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        self.shift = Message.self.shift
        self.encrypting_dict = Message.self.build_shift_dict(shift)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(26):
            num = 0
            text = self.message_text.apply_shift(i)
            words = text.split(" ")
            for i in words:
